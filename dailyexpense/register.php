...
<body>
  <div class="signup-form">
    <form action="" method="POST" autocomplete="off">
      ...
      <div class="form-group">
        <label class="form-check-label"><input type="checkbox" required="required">The above given information is best of my knowledge</label>
      </div>
      <div class="col-md-12 my-2"><?php echo $alert; ?></div>
      <div class="form-group">
        <button type="submit" name="submit" class="btn btn-danger btn-lg btn-block" style="border-radius:0%;">Register</button>
      </div>
    </form>
