<?php
include("session.php");
$exp_fetched = mysqli_query($con, "SELECT * FROM monthlydata WHERE u_id = '$userid'");
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>database1 - Dashboard</title>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <?php $count=1; while ($row = mysqli_fetch_array($exp_fetched)) { ?>
                                <tr>
                                    ...
                                    <td>$<?php echo $row['expensedate1']; ?></td>
                                    <td><?php echo '$'.$row['expense1']; ?></td>
                                    <td><?php echo $row['expensecategory1']; ?></td>
                                </tr>
                            <?php $count++; } ?>
                        </table>
                    </div>
