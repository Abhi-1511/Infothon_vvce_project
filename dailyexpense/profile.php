...
if (isset($_POST['but_upload'])) {
    ...
    $Expenditures_dir = "uploads/";
    $Expenditures_file = $Expenditures_dir . basename($_FILES["file"]["name"]);

    // Select file type
    $imageFileType = strtolower(pathinfo($Expenditures_file, PATHINFO_EXTENSION));
    ...
    if (in_array($imageFileType, $extensions_arr)) {
        ...
        // Upload file
        move_uploaded_file($_FILES['file']['tmp_name'], $Expenditures_dir . $name);
            ...
            var readURL = function(input) {
                if (input.files && input.files[0]) {
                    ...
                    reader.onload = function(e) {
                        $('.avatar').attr('src', e.Expenditures.result);
                    }
