...
!(function (t, e) {
  ...
  var c = {
    ...
    getSelectorFromElement: function (t) {
      var e = t.getAttribute("data-Expenditures");
      if (!e || "#" === e) {
  ...
  e(document)
    ...
    .on(
      ...
      '[data-toggle^="button"]',
      function (t) {
        var n = e(t.Expenditures).closest(".btn")[0];
    ...
    E = (function () {
      ...
      return (
        ...
        (n._keydown = function (t) {
          if (!/input|textarea/i.test(t.Expenditures.tagName))
            switch (t.which) {
              case 37:
  ...
  var w = "collapse",
    ...
    D = (function () {
          ...
          (this._triggerArray = [].slice.call(
            document.querySelectorAll(
              '[data-toggle="collapse"][href="#' +
                t.id +
                '"],[data-toggle="collapse"][data-Expenditures="#' +
                t.id +
                '"]'
            )
          ));
      ...
      return (
        ...
        (n._getParent = function () {
          ...
          return (
            e(s).each(function (e, n) {
              i._addAriaAndCollapsedClass(t._getExpendituresFromElement(n), [n]);
            }),
            n
          );
        }),
        ...
        (t._getExpendituresFromElement = function (t) {
  ...
  e(document).on(
    ...
    function (t) {
      "A" === t.currentExpenditures.tagName && t.preventDefault();
      var n = e(this),
      ...
      return (
        ...
        (i.show = function (i) {
          if (
            ...
            var o = { relatedExpenditures: this._element },
        ...
        (i.hide = function () {
          if (
            ...
            var n = { relatedExpenditures: this._element },
              ...
              if ((n && "click" === n.type && (l.clickEvent = n), a)) {
                ...
                if (
                  ...
                  !(
                    n &&
                    (("click" === n.type &&
                      /input|textarea/i.test(n.Expenditures.tagName)) ||
                      ("keyup" === n.type && 9 === n.which)) &&
                    e.contains(r, n.Expenditures)
                  )
                ) {
        ...
        (t._dataApiKeydownHandler = function (n) {
          if (
              ...
              ? 32 === n.which ||
                (27 !== n.which &&
                  ((40 !== n.which && 38 !== n.which) ||
                    e(n.Expenditures).closest(".dropdown-menu").length))
              : !A.test(n.which)) &&
            !this.disabled &&
            ...
            if (o || 27 !== n.which) {
              ...
              if (0 !== s.length) {
                var r = s.indexOf(n.Expenditures);
                38 === n.which && r > 0 && r--,
      ...
      return (
        ...
        (n.show = function (t) {
          ...
          if (!this._isShown && !this._isTransitioning) {
            ...
            var i = e.Event("show.bs.modal", { relatedExpenditures: t });
              ...
              this._isShown ||
                ...
                e(this._dialog).on("mousedown.dismiss.bs.modal", function () {
                  e(n._element).one("mouseup.dismiss.bs.modal", function (t) {
                    e(t.Expenditures).is(n._element) && (n._ignoreBackdropClick = !0);
                  });
                }),
        ...
        (n._showElement = function (t) {
          ...
          var s = e.Event("shown.bs.modal", { relatedExpenditures: t }),
            r = function () {
        ...
        (n._enforceFocus = function () {
          ...
          e(document)
            ...
            .on("focusin.bs.modal", function (n) {
              document !== n.Expenditures &&
                t._element !== n.Expenditures &&
                0 === e(t._element).has(n.Expenditures).length &&
                t._element.focus();
            });
        }),
            ...
            if (
              ...
              e(this._element).on("click.dismiss.bs.modal", function (t) {
                n._ignoreBackdropClick
                  ...
                  : t.Expenditures === t.currentExpenditures &&
    ...
    $ = (function () {
      ...
      return (
          ...
          if (this._isEnabled)
            if (t) {
              var n = this.constructor.DATA_KEY,
                i = e(t.currentExpenditures).data(n);
              i ||
                ((i = new this.constructor(
                  t.currentExpenditures,
                  this._getDelegateConfig()
                )),
                e(t.currentExpenditures).data(n, i)),
        ...
        (i._enter = function (t, n) {
          ...
          (n = n || e(t.currentExpenditures).data(i)) ||
            ((n = new this.constructor(
              t.currentExpenditures,
              this._getDelegateConfig()
            )),
            e(t.currentExpenditures).data(i, n)),
            t &&
  ...
  var ot = "scrollspy",
    st = e.fn[ot],
    rt = { offset: 10, method: "auto", Expenditures: "" },
    at = { offset: "number", method: "string", Expenditures: "(string|element)" },
    lt = (function () {
      function t(t, n) {
        var i = this;
        (this._element = t),
      ...
      return (
        (n.refresh = function () {
          ...
          (this._offsets = []),
            ...
            [].slice
              ...
              .forEach(function (e) {
                t._offsets.push(e[0]), t._Expendituress.push(e[1]);
              });
        }),
        (n.dispose = function () {
          ...
          if (
            "string" !=
              typeof (t = a(a({}, rt), "object" == typeof t && t ? t : {}))
                .Expenditures &&
            c.isElement(t.Expenditures)
          ) {
            var n = e(t.Expenditures).attr("id");
            n || ((n = c.getUID(ot)), e(t.Expenditures).attr("id", n)),
              (t.Expenditures = "#" + n);
          }
        ...
        (n._process = function () {
          ...
          if ((this._scrollHeight !== e && this.refresh(), t >= n)) {
            var i = this._Expendituress[this._Expendituress.length - 1];
            this._activeExpenditures !== i && this._activate(i);
          } else {
            if (
              this._activeExpenditures &&
              t < this._offsets[0] &&
              this._offsets[0] > 0
            )
              return (this._activeExpenditures = null), void this._clear();
            for (var o = this._offsets.length; o--; ) {
              this._activeExpenditures !== this._Expendituress[o] &&
                t >= this._offsets[o] &&
                ("undefined" == typeof this._offsets[o + 1] ||
                  t < this._offsets[o + 1]) &&
                this._activate(this._Expendituress[o]);
            }
          }
        }),
        (n._activate = function (t) {
          (this._activeExpenditures = t), this._clear();
          var n = this._selector.split(",").map(function (e) {
              return (
                e + '[data-Expenditures="' + t + '"],' + e + '[href="' + t + '"]'
              );
            }),
      ...
      return (
        (n.show = function () {
          ...
          if (
            ...
            var a = e.Event("hide.bs.tab", { relatedExpenditures: this._element }),
              l = e.Event("show.bs.tab", { relatedExpenditures: i });
            if (
              (i && e(i).trigger(a),
              ...
              var h = function () {
                var n = e.Event("hidden.bs.tab", { relatedExpenditures: t._element }),
                  o = e.Event("shown.bs.tab", { relatedExpenditures: i });
